...
- FastAPI server exposing:
  - Classic chat endpoint: POST /api/olexi-chat (AI required)
...
- If GOOGLE_API_KEY is missing/invalid or AI fails:
  - /api/olexi-chat → 503 Service Unavailable
...
- POST /api/olexi-chat — One-shot chat (plan → scrape → summarize). AI required.
